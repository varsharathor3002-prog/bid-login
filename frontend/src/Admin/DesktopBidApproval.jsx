...
// ── REMOVED make_in_india from GENERAL_DOCS ──
const GENERAL_DOCS = [
        ...
        <div className="flex items-center gap-3">
          <div
            className={`p-2 rounded-full ${
              open ? "bg-orange-200 text-orange-700" : "bg-orange-100 text-orange-600 group-hover:bg-orange-200"
            }`}
          >
            📁
          </div>
              ...
              {displayDocs.length > 0 ? (
                displayDocs.map((doc) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 bg-green-500 text-white text-xs">
                        ✓
                      </div>
...
// ── MakeInIndiaView — generates PDF from backend (like General Docs) ──
  ...
  const fetchBids = async () => {
    ...
    try {
      ...
      const normalized = data.map((bid) => ({
        ...
        freightInstallation_price: bid.freightInstallation_price || bid.freight_price || 0,
        ...
        <div className="fixed inset-0 bg-black/60 z-50 overflow-y-auto py-8 px-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-7xl mx-auto">
            <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50 rounded-t-xl">
              ...
              <button type="button" onClick={closeModal} className="text-2xl text-gray-400 hover:text-gray-700 leading-none">
                ×
              </button>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                ...
                {/* ── Bid End Date, Address, Local Content — 3 in 1 row ── */}
                <div>
                ...
                {/* ── Compliance Documents: Special Doc, General Docs, Make in India (3 columns) ── */}
                <div className="md:col-span-2 lg:col-span-3">
                ...
                <PriceField
                  ...
                  priceName="motherboard_descp_price"
                  isTextArea
                  optional
                  form={form}
                  handleChange={handleChange}
