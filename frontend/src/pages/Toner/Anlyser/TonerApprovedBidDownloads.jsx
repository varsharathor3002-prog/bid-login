...
// Same to same as Desktop's ApprovedBidDownloads.jsx, pointed at Toner's own
// bid-documents endpoint and doc_type list (see generate_toner_documents in
// Toner.py) — the old version of this file only linked the single raw
// "upload_document" file, none of the actual generated GeM certificates.
const API_BASE = `${import.meta.env.VITE_API_URL}/toner-bids`;
...
export default function TonerApprovedBidDownloads() {
  const { id } = useParams();
    ...
    <div className="mx-auto max-w-4xl p-8">
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        {APPROVED_DOWNLOADS.map(([docId, label]) => (
          <div
            key={docId}
            className="grid grid-cols-[1fr_auto] items-center gap-4 border-b border-slate-100 px-5 py-4 last:border-0"
          >
