...
// Same to same as Desktop's/AIO's ApprovedBiddingDetails.jsx — the "Approved
// Details For Bidding" document view that opens from the Analyser's Approved
// tab / Transfer Catalogue to GeM tab, cloned for Toner.
const API_BASE = import.meta.env.VITE_API_URL;

export default function TonerApprovedBiddingDetails() {
  const { id } = useParams();
  ...
  const downloadPdf = async () => {
    ...
    setError("");
    try {
      const response = await fetch(`${API_BASE}/toner-bids/${id}/generate-docs/`, {
        method: "POST",
