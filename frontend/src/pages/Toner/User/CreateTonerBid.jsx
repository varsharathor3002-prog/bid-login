...
// Same reasoning as Aio's CreateAioBid.jsx: clear storage only when the flow
// actually starts fresh (not at the end), so a half-filled bid never silently
