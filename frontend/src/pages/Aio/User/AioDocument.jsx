...
export default function AioDocument({ bidData, onSuccess }) {
  ...
  const handleViewCertificate = async (docId) => {
    ...
    try {
      const response = await fetch(`${API_BASE}/aio-bids/${bidData.bid_id}/generate-docs/`, {
        method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/aio-bids/${bidData?.bid_id}/update-docs/`, {
        method: "POST",
        body: formData,
      });
