...
function Basic({ saved, onNext }) {
  ...
  return <div className="w-full max-w-[600px] bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4"><div><Label>Quantity</Label><Input required type="number" placeholder="Enter Quantity" value={form.qty} onChange={(e) => change("qty", e.target.value)}/></div><div><Label>Pin Code</Label><Input required type="number" placeholder="Enter PIN Code" value={form.pincode} onChange={(e) => change("pincode", e.target.value)}/></div></div>
