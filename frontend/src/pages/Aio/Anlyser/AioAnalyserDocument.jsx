...
// India stays Admin-only (see AioBidApproval.jsx's OnDemandDocView), matching
...
export default function AioAnalyserDocument() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/aio-bids/${bidId}/review/`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          ...bidData,
      ...
      setSuccess(true);
      setTimeout(() => navigate("/analyser-dashboard/aio"), 1400);
    } catch (err) {
