...
// Same to same as Desktop's ApprovedBidDownloads.jsx, pointed at AIO's own
// bid-documents endpoint and doc_type list (see generate_aio_documents in
// Aio.py) — the old version of this file only linked the single raw
// "upload_document" file, none of the actual generated GeM certificates.
const API_BASE = `${import.meta.env.VITE_API_URL}/aio-bids`;
...
export default function AioApprovedBidDownloads() {
  const { id } = useParams();
