...
urlpatterns = [
    ...
    path("delete-admin/<int:id>/", views.delete_admin),
    path("management-list/", views.management_list),
    path("register-management/", views.register_management),
    path("delete-management/<int:id>/", views.delete_management),
    path('login/', views.login),
    path("forgot-password/", views.forgot_password),
    path("component-rates/", views.component_rates, name="component_rates"),
    path("component-rates/pdf/", views.component_rates_pdf, name="component_rates_pdf"),
    ...
    path("gem/extension/jobs/<int:job_id>/claim/", views.extension_claim_job, name="extension_claim_job"),
    path("gem/extension/jobs/<int:job_id>/mrp-document/", views.extension_mrp_document, name="extension_mrp_document"),
    path("gem/extension/jobs/<int:job_id>/bis-document/", views.extension_bis_document, name="extension_bis_document"),
    path("gem/extension/jobs/<int:job_id>/product-images/", views.extension_product_images, name="extension_product_images"),
    path("gem/extension/jobs/<int:job_id>/report/", views.extension_report_job, name="extension_report_job"),
    path("gem/jobs/<int:job_id>/retry/", views.retry_gem_job, name="retry_gem_job"),
    path("gem/bid-results/", views.gem_bid_results, name="gem_bid_results"),
    ...
    path("gem/bid-opportunities/", views.gem_bid_opportunities, name="gem_bid_opportunities"),
    path("gem/bid-opportunities/parse-pdf/", views.parse_gem_bid_pdf, name="parse_gem_bid_pdf"),
    path("gem/bid-assignments/", views.gem_bid_assignments, name="gem_bid_assignments"),
